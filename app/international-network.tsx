...
export default function InternationalNetworkPage() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.intro}>{"The International Federation of Gynecology and Obstetrics (FIGO) is the world's largest alliance of national societies of obstetricians and gynecologists. Founded in 1954, FIGO represents over 130 member societies worldwide and works to advance women's health through advocacy, education, and global collaboration."}</Text>
      ...
      <View style={styles.contactCard}>
        ...
        <Text style={styles.text}>✉️ Email: figo@figo.org</Text>
...
const styles = StyleSheet.create({
  ...
  link: { color: '#2196F3', fontSize: 14, textDecorationLine: 'none', marginTop: 6 },
});
